...
<div class="constitution">
    <h1 class="noUnderscore">THE OLD MAN TABLE CONSTITUTION</h1>
    ...
    <h3 class="noUnderscore clickable" on:click={() => goToSection(two)}>Section 2: Drafting</h3>
        ...
        <h4 class="noUnderscore clickable" on:click={() => goToSection(twoTwo)}>2.2 Other Draft Information</h4>
    ...
    <p>Trading of players and draft picks (up to 3 drafts away) are allowed. Trades will process immediately. Tradable assets include players, draft picks, and FAAB $ only.</p>
    ...
    <div class="subBlock">
        <p>There are no vetos in this league. Trades will be processed immediately.</p>
    </div>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $100. $0 bids are allowed. Bids will process Wednesdays and Fridays at 3AM EST.</p>

    <p>FAAB budgets will reset each season once the league is rolled over.</p>
    ...
    <div class="subBlock">
        <table class="positionMaximums">
            <tr><td>Non-playoff teams</td><td class="right">1-6</td></tr>
            <tr><td>Eliminated in Wild Card round</td><td class="right">7-8</td></tr>
            <tr><td>Eliminated in Semi Final round</td><td class="right">9-10</td></tr>
    ...
    <p>The league scoring system breakdown is listed on the Sleeper fantasy app (for the most part, it follows typical Standard Scoring). The scoring system will never change without a majority league vote.</p>
